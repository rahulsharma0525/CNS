...
/*can comment*/		MAPBOXSATELLITELABELLED = new MapBoxTileSource("MapBoxSatelliteLabelled", ResourceProxy.string.mapquest_aerial, 1, 19, 256, ".png");
/*can comment*/		TileSourceFactory.addTileSource(MAPBOXSATELLITELABELLED);
		
		map = (MapView) findViewById(R.id.map);
		
//		String tileProviderName = prefs.getString("TILE_PROVIDER", "Mapnik");//Rahul
//		try {
//			ITileSource tileSource = TileSourceFactory.getTileSource(tileProviderName);//Rahul
//			map.setTileSource(tileSource);//Rahul
//		} catch (IllegalArgumentException e) {//Rahul
//			map.setTileSource(TileSourceFactory.MAPNIK);//Rahul
//		}//Rahul
...
/*can comment*/		map.getOverlays().add(overlay);//Rahul
		...
		if (savedInstanceState == null){
			...
			//viaPoints = savedInstanceState.getParcelableArrayList("viapoints");//Rahul
		}
	...
	//	mViaPointInfoWindow = new ViaPointInfoWindow(R.layout.itinerary_bubble, map);//Rahul
		//updateUIWithItineraryMarkers();//Rahul
		
		//Tracking system:
//		mTrackingModeButton = (Button)findViewById(R.id.buttonTrackingMode);//Rahul
//		mTrackingModeButton.setOnClickListener(new View.OnClickListener() {//Rahul
//			public void onClick(View view) {//Rahul
//				mTrackingMode = !mTrackingMode;//Rahul
//				updateUIWithTrackingMode();//Rahul
//			}//Rahul
//		});//Rahul
//		if (savedInstanceState != null){
...
//		View expander = (View)findViewById(R.id.expander);//Rahul
//		expander.setOnClickListener(new View.OnClickListener() {//Rahul
//			public void onClick(View view) {//Rahul
//				View searchPanel = (View)findViewById(R.id.search_panel);//Rahul
//				if (searchPanel.getVisibility() == View.VISIBLE){//Rahul
//					searchPanel.setVisibility(View.GONE);//Rahul
//				} else {//Rahul
...
////		});//Rahul
		...
		//(a little bit strange, but if we register it on mapView, it will catch map drag events)//Rahul
...
//			break;
	...
	void updateUIWithRoad(Road road){
		roadNodeMarkers.getItems().clear();
	//	TextView textView = (TextView)findViewById(R.id.routeInfo);//Rahul
		//textView.setText("");//Rahul
		List<Overlay> mapOverlays = map.getOverlays();
		if (roadOverlay != null){
		...
		//textView.setText(road.getLengthDurationText(-1));//Rahul
    }
...
//		if (map.getTileProvider().getTileSource() == TileSourceFactory.MAPNIK)//Rahul
//			menu.findItem(R.id.menu_tile_mapnik).setChecked(true);//Rahul
//		else if (map.getTileProvider().getTileSource() == TileSourceFactory.MAPQUESTOSM)//Rahul
//			menu.findItem(R.id.menu_tile_mapquest_osm).setChecked(true);//Rahul
//		else if (map.getTileProvider().getTileSource() == MAPBOXSATELLITELABELLED)//Rahul
//			menu.findItem(R.id.menu_tile_mapbox_satellite).setChecked(true);//Rahul
...
//			if (mKmlDocument.mKmlRoot==null)//Rahul
//				return false;//Rahul
//			myIntent = new Intent(this, KmlTreeActivity.class);//Rahul
//			//myIntent.putExtra("KML", mKmlDocument.kmlRoot);//Rahul
//			mKmlStack.push(mKmlDocument.mKmlRoot.clone());//Rahul
//			startActivityForResult(myIntent, KML_TREE_REQUEST);//Rahul
//			return true;//Rahul
...
//			updateUIWithKml();
//			return true;
//		case R.id.menu_route_osrm://Rahul
	...
	@Override public void onLocationChanged(final Location pLoc) {
		...
		if (prevLocation != null && pLoc.getProvider().equals(LocationManager.GPS_PROVIDER)){
			...
			*/
			...
			//TextView speedTxt = (TextView)findViewById(R.id.speed);//Rahul
